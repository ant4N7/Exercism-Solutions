...
class Tree:
    ...
    Attributes:
        label: Identifier for this node (can be int or str)
    ...
    @staticmethod
    def path_from_self(node: Tree | None, to_node: int | str) -> list[Tree] | None:
    ...
    def from_pov(self, from_node: int | str) -> Tree:
    ...
    def path_to(self, from_node: int | str, to_node: int | str) -> list[int | str]:

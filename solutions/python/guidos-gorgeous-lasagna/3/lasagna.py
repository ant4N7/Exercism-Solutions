...
def preparation_time_in_minutes(number_of_layers):
    ...
    argument and returns the preparation time in minutes based on the 'PREPARATION_TIME'.
    """
...
def elapsed_time_in_minutes(number_of_layers, elapsed_bake_time):
    ...
    :param elapsed_bake_time: int - the number of minutes the lasagna has been baking in the oven.
    :return: int - time elapsed since beginning the lasagna

    Function that takes the number of layers and the elapsed bake time as arguments and 
    returns the total number of minutes you have been cooking
    """
